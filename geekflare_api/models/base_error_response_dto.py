...
class BaseErrorResponseDto(BaseModel):
    """
    ...
    details: Optional[StrictStr] = Field(default=None, description="Detailed error information", json_schema_extra={"examples": ["The URL must be a valid HTTP or HTTPS URL"]})
    __properties: ClassVar[List[str]] = ["timestamp", "apiStatus", "apiCode", "message", "details"]
