...
class DnsSecResponseDto(BaseModel):
    """
    DnsSecResponseDto
    """ # noqa: E501
    ...
    data: DnsSecDataDto = Field(description="DNSSEC test result data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": DnsSecMetaDto.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": DnsSecDataDto.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
