...
class LighthouseResponseDto(BaseModel):
    """
    ...
    data: StrictStr = Field(description="URL to the Lighthouse report", json_schema_extra={"examples": ["https://example.com/report.html"]})
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": LighthouseMetaDto.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": obj.get("data")
        })
        return _obj
