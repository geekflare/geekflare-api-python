...
class MetaScrapeMetaDto(BaseModel):
    """
    MetaScrapeMetaDto
    """ # noqa: E501
    ...
    format: StrictStr = Field(description="Output format of the result", json_schema_extra={"examples": ["json"]})
    ...
    __properties: ClassVar[List[str]] = ["url", "device", "format", "fileOutput", "blockAds", "renderJS", "proxyCountry", "test"]
