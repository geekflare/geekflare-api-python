...
class MixedContentResponseDto(BaseModel):
    """
    ...
    meta: MixedContentMetaDto = Field(description="Metadata about the mixed content test")
    data: MixedContentResponseDtoData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": MixedContentMetaDto.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": MixedContentResponseDtoData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
