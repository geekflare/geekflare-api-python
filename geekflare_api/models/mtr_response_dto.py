...
class MtrResponseDto(BaseModel):
    """
    MtrResponseDto
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": MtrMetaDto.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": [MtrDataDto.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
