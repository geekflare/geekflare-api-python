...
class PingResponseDto(BaseModel):
    ...
    data: PingDataDto = Field(description="Ping result statistics")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": PingMetaDto.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": PingDataDto.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
