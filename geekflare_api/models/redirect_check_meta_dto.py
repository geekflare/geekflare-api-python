...
class RedirectCheckMetaDto(BaseModel):
    """
    RedirectCheckMetaDto
    """ # noqa: E501
    url: StrictStr = Field(description="The original URL checked", json_schema_extra={"examples": ["example.com"]})
    proxy_country: Dict[str, Any] = Field(description="Proxy country used (if any)", alias="proxyCountry", json_schema_extra={"examples": ["US"]})
    test: TestMetaDto = Field(description="Test details object")
    __properties: ClassVar[List[str]] = ["url", "proxyCountry", "test"]
