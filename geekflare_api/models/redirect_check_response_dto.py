...
class RedirectCheckResponseDto(BaseModel):
    """
    ...
    data: List[RedirectHopDto] = Field(description="List of redirection hops with status and headers.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": RedirectCheckMetaDto.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": [RedirectHopDto.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
