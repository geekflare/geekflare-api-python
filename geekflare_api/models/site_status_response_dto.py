...
class SiteStatusResponseDto(BaseModel):
    """
    ...
    meta: SiteStatusMetaDto = Field(description="Metadata about the site status check.")
    data: Dict[str, Any] = Field(description="HTTP status information from the site check.", json_schema_extra={"examples": [{"statusCode": 200, "reasonPhrase": "OK"}]})
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": SiteStatusMetaDto.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": obj.get("data")
        })
        return _obj
