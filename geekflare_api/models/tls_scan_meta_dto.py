...
class TlsScanMetaDto(BaseModel):
    """
    TlsScanMetaDto
    """ # noqa: E501
    url: StrictStr = Field(description="The target URL checked for TLS support", json_schema_extra={"examples": ["example.com"]})
    test: TestMetaDto = Field(description="Test metadata object")
    __properties: ClassVar[List[str]] = ["url", "test"]
