...
class TlsScanResponseDto(BaseModel):
    """
    TlsScanResponseDto
    """ # noqa: E501
    ...
    data: TlsScanDataDto = Field(description="TLS scan result data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": TlsScanMetaDto.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": TlsScanDataDto.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
